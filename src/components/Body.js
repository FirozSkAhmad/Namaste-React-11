    ...
    return (
        <div className="mt-5">
            <div className="flex gap-5 mb-3 justify-center items-center">
                <div >
                    <input className="border-2 border-blue-50 p-1 rounded-xl" type="text" placeholder="Resturant Name" defaultValue={name} onChange={(e) => setName(e.target.value)}></input>
                    <button className="bg-purple-100 p-1 rounded-xl text-lg font-medium" onClick={() => searchHandler(data, name, setDataF)}>search</button>
                </div>
                <div>
